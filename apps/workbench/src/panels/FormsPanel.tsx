  ...
  return (
    <div className="tr-panel tr-panel--forms">
      <div className="tr-panel__main">
        ...
        {selectedToken ? (
          <div className="tr-forms__token-summary">
            <div className="tr-panel__section-head">SELECTED SAMPLE</div>
            <div className="tr-forms__token-row">
              ...
              <button
                ...
                aria-label="Edit form exceptions in Details panel"
              >
                Edit in Details
              </button>
            </div>
