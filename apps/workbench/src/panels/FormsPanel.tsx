    ...
    <div className="tr-panel tr-panel--forms">
      <div className="tr-panel__main">
        ...
        <div className="tr-forms__bank-context">
          ...
          {selectedToken ? (
            <div className="tr-forms__sample-summary" aria-label={`Selected sample: ${selectedToken.literal}`}>
              <span className="tr-forms__token-literal">{selectedToken.literal}</span>
              <span className="tr-forms__token-role">{bankRole}</span>
              <p className="tr-forms__hint">
                Form exceptions for this sample are edited in the Inspector panel.
              </p>
            </div>
          ) : activeBank ? (
            <p className="tr-forms__desc">
              Select a sample in Banks &amp; Samples to see its form exceptions in Inspector.
            </p>
          ) : (
            <p className="tr-forms__desc">
